...
```
Можна ще підкрутити `keyFormat`, щоб не дублювались директорії.Але то таке
...
Argo Workflows у цьому кейсі зайшов як треба. Ручні запуски перестають бути шаманським ритуалом, історія запусків лежить на місці, доступи не розповзаються в хаос, а команда менше страждає в стилі "хто, де і чому це запускав о 04:20, воно запускалось за розкладом чи ні та де DevOps який може подивтись логи?".
